...
const file_proto_shorten_proto_rawDesc = "" +
	"\n" +
	"\x13proto/shorten.proto\x12\ashorten\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\x03url\x18\x01 \x03(\v2\x10.shorten.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	"\tshort_url\x18\x01 \x01(\tR\bshortUrl\x12!\n" +
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl2\xe0\x01\n" +
	"\x10ShortenerService\x12E\n" +
	"\n" +
	"ShortenURL\x12\x1a.shorten.URLShortenRequest\x1a\x1b.shorten.URLShortenResponse\x12B\n" +
	"\tExpandURL\x12\x19.shorten.URLExpandRequest\x1a\x1a.shorten.URLExpandResponse\x12A\n" +
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x19.shorten.UserURLsResponseB\"Z github.com/shorten/shorten/protob\x06proto3"

var file_proto_shorten_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_shorten_proto_goTypes = []any{
	(*URLShortenRequest)(nil),  // 0: shorten.URLShortenRequest
	(*URLShortenResponse)(nil), // 1: shorten.URLShortenResponse
	(*URLExpandRequest)(nil),   // 2: shorten.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: shorten.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: shorten.UserURLsResponse
	(*URLData)(nil),            // 5: shorten.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_proto_shorten_proto_depIdxs = []int32{
	5, // 0: shorten.UserURLsResponse.url:type_name -> shorten.URLData
	0, // 1: shorten.ShortenerService.ShortenURL:input_type -> shorten.URLShortenRequest
	2, // 2: shorten.ShortenerService.ExpandURL:input_type -> shorten.URLExpandRequest
	6, // 3: shorten.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: shorten.ShortenerService.ShortenURL:output_type -> shorten.URLShortenResponse
	3, // 5: shorten.ShortenerService.ExpandURL:output_type -> shorten.URLExpandResponse
	4, // 6: shorten.ShortenerService.ListUserURLs:output_type -> shorten.UserURLsResponse
...
func file_proto_shorten_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_shorten_proto_rawDesc), len(file_proto_shorten_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
